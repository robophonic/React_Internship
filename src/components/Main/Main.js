                                        ...
                                        <div className="terms_box">
                                            ...
                                            <div className="item">
                                                ...
                                                <div className="text">
                                                    ...
                                                    <p>Для загрузки перейдет на официальный сайт <a href="https://nodejs.org/en/" target="_blank">https://nodejs.org/en/</a>. На главной странице мы сразу увидим две возможные опции для загрузки: самая последняя версия NodeJS и LTS-версия.</p>
                                                </div>
                                            </div>
                                            <div className="item">
                                                <div className="icon_box">
